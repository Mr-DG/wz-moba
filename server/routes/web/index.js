module.exports = app => {
  ...
  router.get('/news/init', async (req, res) => {
    ...
    const newsTitles = ['司马懿-暗渊魔法优化方向&amp;嫦娥-拒霜思后续制作方向沟通【老亚瑟的答疑时间】', '王者荣耀主播联赛今日开赛！', '狄某有话说 |元芳出装三个宝石，买二送一还是消极对局？', '周年庆限定皮肤返场票选规则沟通【老亚瑟的答疑时间】', '嫦娥源·梦皮肤特效研讨会开启啦~', '10月20日全服不停机更新公告', '南京Hero久竞冠军宝箱赛事商城上架', '10月18日全服不停机更新公告', '10月17日周年福利·送限定皮肤异常说明', '10月16日登录异常恢复说明', '周年庆福利第三波，三大精彩内容来袭', '限定皮肤限时体验活动公告', '限定皮肤返场投票活动开启公告', '【周年福利-送限定皮肤】活动开启公告', '觉醒之战玩法限时开启公告', 'KPL预报丨上海RNGM vs 杭州LGD大鹅，谁能破局夺胜', '21秋第四周最佳阵容：广州TTG.九尾制霸峡谷，获双料周最佳', '南京Hero久竞冠军宝箱赛事商城上架', 'KPL预报丨虎狼之争，MTG能否复仇重庆狼队？', '合作赛道火热开启中，谁是下一个XYG ？']
  ...
  router.get('/heroes/init', async (req, res) => {
    ...
    for (let cat of rawData) {
      ...
      // 给爬取的数据中的heroes的每个hero添加上分类categories
