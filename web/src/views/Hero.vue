<template>
  <div class="page-hero" v-if="model">
    ...
    <div>
      <div>
        <div class="nav d-flex jc-around pt-3 pb-2 border-bottom bg-white">
          <div class="nav-item active">
            <nav-link>英雄初始</nav-link>
          </div>
          <div class="nav-item">
            <nav-link>进阶攻略</nav-link>
          </div>
        </div>
        <swiper>
          <swiper-slide>
            <div>
              <div class="p-3 bg-white border-bottom">
                <div class="d-flex">
                  ...
                  <router-link tag="button" to="/" class="btn btn-lg flex-1 ml-3">
                    <i class="iconfont icon-back"></i>
                    一图识英雄
                  </router-link>
                </div>
                ...
                <div class="skills bg-white mt-4">
                  <div class="d-flex jc-around">
                    <img class="icon" @click="currntSkillIndex = i" :class="{active: (i === currntSkillIndex)}"
...
export default {
  ...
  computed: {
    currentSkill () {
      return this.model.skills[this.currntSkillIndex]
    }
  },
  methods: {
    async fetch () {
